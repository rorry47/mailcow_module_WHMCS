...
class MailcowAPI{
  ...
  public $baseurl;
    ...
    public function __construct($params) {
        ...
        include('config.php');
        $this->aliases = $SET_aliases;
        $this->NUM_MAILBOXES = $SET_MMAILBOXES;
        $this->MAILBOXQUOTA = $SET_MAILBOXQUOTA;
        $this->UNL_DEFQUOTA = $SET_DEFQUOTA;
        $this->UNL_MAILBOXES = $SET_MAILBOXES;
        $this->UNL_rl_value = $SET_rl_value;
        $this->UNL_rl_frame = $SET_rl_frame;
  ...
  private function _manageDomain($domain, $product_config, $action){
    ...
    $attr['mailboxes'] = "$this->NUM_MAILBOXES";
    $attr['defquota'] =  "$this->UNL_DEFQUOTA";
    $attr['maxquota'] = "$this->MAILBOXQUOTA";
    $attr['quota'] = "$this->MAILBOXQUOTA";
    $attr['backupmx'] =  '0';
    $attr['relay_all_recipients'] =  '0';
    $attr['rl_value'] = "$this->UNL_rl_value";
    $arrt['rl_frame'] = "$this->UNL_rl_frame";
